...
;(function ($, window, document, undefined) {
	...
	$.wcpEditorEventExtraMainButtonClick = function(buttonName) {
		...
		if (buttonName == 'purchase') {
			window.open('https://webcraftplugins.com/image-map-pro/?platform=wordpress&utm_source=lite-version&utm_medium=purchase-button', '_blank');
		}
	}
